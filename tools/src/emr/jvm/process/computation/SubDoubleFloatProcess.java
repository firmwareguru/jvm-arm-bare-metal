 ...
 *
 * SubDoubleFloatProcess:  Sub value is register VALUE1 with value in register VALUE2 and put result in VALUE
 *
 *      value1 = frame.popInt();
 *      value2 = frame.popInt();
 ...
 * @author Evan Ross
 */
public class SubDoubleFloatProcess extends JVMProcess
{
    
    /**
     * Creates a new instance of AddSingleIntProcess
     */
    public SubDoubleFloatProcess()
    {
        super("SubDoubleFloat");
    }
