/*
 * AddDoubleIntProcess.java
 *
 * Created on March 14, 2007, 10:18 PM
 *
 * AddDoubleIntProcess:  Add value is register VALUE1 with value in register VALUE2 and put result in VALUE
 *
 *      value1 = frame.popInt();
 *      value2 = frame.popInt();
 ...
 * @author Evan Ross
 */
public class AddDoubleIntProcess extends JVMProcess
{
    
    /**
     * Creates a new instance of AddSingleIntProcess
     */
    public AddDoubleIntProcess()
    {
        super("AddDoubleInt");
    }
